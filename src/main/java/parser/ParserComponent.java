    ...
    */
    private String instruction() throws IOException {
        ...
        if(currentToken.getType() == TokenType.IF)
        {
            ...
            currentToken = scanner.getNextToken();
            temp3 = expression();
            if((temp3.substring(0,3).equals("!#!")))
                temp1 = GenTrip("=", identificator, temp3.substring(3, temp3.length() - 3));
            else
...
//todocheck substr
    ...
    private String term() throws IOException {
        ...
        {
            t1 = "Constanta " + currentToken.getValue();
    ...
    private void displayError(int errorCode)
    {
        ...
        switch(errorCode)
        {
            case 1 :  message = "Nu se poate deschide fisierul!"; break;
            case 2 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \"begin\" !"; break;
            case 3 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \"end\" !"; break;
            case 4 :  message = "Eroare la linia "+ this.currentToken.getLine() +": atomul \""+ this.currentToken.getValue() +"\" este ilegal !"; break;
            case 5 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \"then\" !";break;
            case 6 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \"=\" !";break;
            case 7 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \"if\" sau un nume de variabila !";break;
            case 8 :  message = "Eroare la linia "+ this.currentToken.getLine() +": numarul \""+ this.currentToken.getValue() +"\" este incorect !";break;
            case 9 :  message = "Eroare la linia "+ this.currentToken.getLine() +": lipseste \")\" !";break;
        }
